...
# [![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/UCB-stat-159-s22/hw06-keonetebari.git/HEAD)
# <!-- .. image:: https://mybinder.org/badge_logo.svg
#  :target: https://mybinder.org/v2/gh/UCB-stat-159-s22/hw06-keonetebari.git/HEAD -->
...
if make_plots:
    ...
    plt.savefig(r'figurs/'+eventname+'_strain.'+plottype)
...
if make_plots:
    ...
    plt.title('Advanced LIGO strain data near '+eventname)
    plt.savefig(r'figurs/'+eventname+'_ASDs.'+plottype)
...
if make_plots:
    ...
    plt.savefig(r'figurs/'+eventname+'_H1_spectrogram.'+plottype)
    ...
    plt.savefig(r'figurs/'+eventname+'_L1_spectrogram.'+plottype)
...
if make_plots:
    ...
    plt.title('aLIGO H1 strain data near '+eventname)
    plt.savefig(r'figurs/'+eventname+'_H1_spectrogram_whitened.'+plottype)
    ...
    plt.axis([-0.5, 0.5, 0, 500])
    plt.title('aLIGO L1 strain data near '+eventname)
    plt.savefig(r'figurs/'+eventname+'_L1_spectrogram_whitened.'+plottype)
...
if make_plots:
    ...
    plt.savefig(r'figurs/'+eventname+'_template.'+plottype)
...
for det in dets:
    ...
    if make_plots:
        ...
        plot(time, timemax, tevent, SNR, pcolor, det, eventname, plottype, strain_whitenbp, template_match, template_fft, datafreq, d_eff, freqs, data_psd, fs)
...
#     wavfile.write(r'audio/'+filename,int(fs), d)
...
fmtcsv = ",".join(["%10.6f"] * 5)
np.savetxt(r'data/'+fncsv, datcsv, fmt=fmtcsv, header=headcsv)
